...
INSERT INTO [dbo].[Venue] ([venue_name], [parking], [description], [location], [zip_code])
VALUES
('ABC Stadium', 'Free parking available in adjacent lot.', 'A large outdoor stadium.', '123 Main St', 90210),
('XYZ Arena', 'Parking available for $10 in nearby garage.', 'A smaller indoor arena.', '456 Broad St', 60601),
('Community Center two', 'Parking available on site.', 'A multipurpose indoor facility.', '789 Oak Ave', 10001),
('Community Center', 'Parking available on site.', 'A multipurpose indoor facility.', '789 Oak Ave', 10001);
GO
